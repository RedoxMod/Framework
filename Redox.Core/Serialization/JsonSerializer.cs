...
namespace Redox.Core.Serialization
{
    ...
    public static class JsonSerializer
    {
        ...
        public static string ToJson(object ob, bool indent = true)
        {
            ...
            {
                RedoxMod.GetMod().TempLogger.Error("[JsonParser] An error happened while trying to parse \"{0}\". Error: {1}", nameof(ob), e.Message);
                return string.Empty;
            }
        }
        ...
        public static void ToFile(string path, object ob)
        {
            ...
            {
                RedoxMod.GetMod().TempLogger.Error("[JsonParser] An error happened at \"ToFile\" \"{0}\". Error: {1}", nameof(ob), e.Message);
            }
        }
        public static T FromJson<T>(string json)
        {
            ...
            {
                RedoxMod.GetMod().TempLogger.Error("[JsonParser] An error happened at \"FromJson\". Error: {0} ", e.Message);
                return default;
            }
        }
